...
const StepperForm = ({
      ...
      <form.Field name="type">
        {(field) => (
          <div className="space-y-2">
            {[
              {
                value: "inspeccion_mantos_carbon",
                label: "Inspección de mantos de carbón",
              },
            ...
            <div className="form-control">
              <label className="label">
                <span className="label-text">
                  Coordenada (Formato: F-30-45-160)
                </span>
              </label>
              <input
                type="text"
  ...
  const InspeccionMantosFields: React.FC = () => {
    ...
    const tajos = zona === "Zona Norte" ? ["Annex", "La Puente", "Tabaco"] : [];

    return (
      <div className="space-y-4">
        <h3 className="text-lg font-semibold">
          Inspección de mantos de carbón
        </h3>
  ...
  const SondeoFields: React.FC = () => {
    const [sondeoType, setSondeoType] =
      React.useState<SondeoType>("sondeo_de_pilas");
